...
urlpatterns = [
    ...
    path('password_change/', users_views.CustomPasswordChangeView.as_view(), name='password_change'),
    # path('password_change_done/', users_views.CustomPasswordChangeDoneView.as_view(), name='password_change_done'),
